...
*************************************************************************/
void ogstream::drawPiece(int xCoord, int yCoord, bool black, Rect rectangle[], int num) const
{
   int x = xCoord * 32;
   int y = yCoord * 32;
...
void ogstream::drawKing(Position & pos, bool black)
{
   ...
   drawPiece(pos.getX() - 1, pos.getY() - 1, black, rectangles, 7);
}
...
*************************************************************************/
void ogstream::drawQueen(Position& pos, bool black)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(pos.getX() - 1, pos.getY() - 1, black, rectangles, 9);
}
...
*************************************************************************/
void ogstream::drawRook(Position& pos, bool black)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(pos.getX() - 1, pos.getY() - 1, black, rectangles, 5);
}
...
*************************************************************************/
void ogstream::drawKnight(Position& pos, bool black)
{
   Rect rectangles[] =
   {
...
*************************************************************************/
void ogstream::drawBishop(Position& pos, bool black)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(pos.getX() - 1, pos.getY() - 1, black, rectangles, 6);
}
...
*************************************************************************/
void ogstream::drawPawn(Position& pos, bool black)
{
   Rect rectangles[] =
   {
   ...
   drawPiece(pos.getX() - 1, pos.getY() - 1, black, rectangles, 4);
}
...
************************************************************************/
void ogstream::drawSelected(Position& position)
{
   int pos = position.getX() - 1 + ((position.getY() - 1) * 8);
...
*   INPUT  location  The location of the selected square
************************************************************************/
void ogstream::drawHover(Position & position)
{
   int pos = position.getX() - 1 + ((position.getY() - 1) * 8);
   // do nothing if there is nothing to do
   if (pos < 0 && pos >= 64)
